...
public class Base {
    ...
    public WebDriver getSauceLabDriver(String userName, String key, String os, String browserName, String browserVersion) throws IOException {
        ...
        cap.setCapability("name", "BunceeTest001");
    ...
    public WebDriver getLocalDriver(String os, String browserName) {
        if (browserName.equalsIgnoreCase("firefox")) {
            ...
            if (os.equalsIgnoreCase("windows")) {
                System.setProperty("webdriver.chrome.driver", "C:\\Users\\iamam\\Desktop\\BunPro\\Generic\\src\\driver\\chromedriver.exe");
            } else {
                System.setProperty("webdriver.chrome.driver", "C:\\Users\\iamam\\Desktop\\BunPro\\Generic\\src\\driver\\chromedriver.exe");
            }
    ...
    public void snapScreenshot(String testCaseName) throws Exception {
        Thread.sleep(2000);
        String screenshotLocation = "C:\\Users\\iamam\\Desktop\\BunPro\\Application\\src\\test\\TestResults\\Screenshots\\";
